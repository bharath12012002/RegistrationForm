...
//to click the lead category
cy.get('#card_lead_cat').click()
cy.wait(1000)
...
cy.get('#add').click()
cy.wait(1000)
cy.get('#category_name').type("989898")
cy.wait(1000)
cy.get('#category_description').type("invalid data")
cy.wait(1000)
cy.get('#submit').click()
cy.wait(1000)
cy.get('#category_name').clear()
cy.wait(1000)
cy.get('#category_name').type("Instagram")
cy.wait(1000)
cy.get('#submit').click()
cy.wait(3000)
...
cy.get('#category_name').clear()
cy.wait(1000)
cy.get('#category_name').type("By Friend")
cy.wait(1000)
cy.get('#submit').click()
cy.wait(3000)
